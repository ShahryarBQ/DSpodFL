...
class DSpodFL:
    ...
    def accuracy_calculation_condition(self, total_iter, total_delay):
        cond_eff = self.sim_type == 'eff' and total_iter % (10 ** (len(str(total_iter)) - 1) / 2) == 0
        cond_graph_conn = self.sim_type in ['graph_conn', 'data_dist', 'alpha_beta', 'alpha_beta_v2', 'num_agents'] and total_delay >= self.termination_delay
    ...
    def termination_condition(self, total_iter, total_delay):
        ...
        return cond and self.sim_type in ['graph_conn', 'data_dist', 'alpha_beta', 'alpha_beta_v2', 'num_agents']
